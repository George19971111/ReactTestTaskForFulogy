...
class Cvetsvecheniya extends Component{
    ...
    componentDidMount(){
        if(window.innerWidth <=450){
            ...
            document.querySelector('.mobilecontent_cost').style.display = 'block';
            document.querySelector('.mobilearrowdown').style.display = 'block';
            document.querySelector('.infologotype').style.display = 'none'
        }
        // window.addEventListener('resize',()=>{
        //     if(window.innerWidth <=450){
        //         document.querySelector('.container_header__content__logo').innerHTML =''
        //     }
        // })
    ...
    changerimglinker(e,city){
        ...
        document.querySelector('.mainconfigurator__informationlink_text').innerHTML =e.target.parentNode.querySelector('p').innerHTML
