...
import Dawn from './img/icons/down.png';
class Header extends Component{
    burgetbutton(){
        if(document.getElementById('closebutton').classList.contains('dropdownmenuheader__hidden')){
            document.getElementById('openbutton').classList.add('dropdownmenuheader__hidden')
            document.getElementById('closebutton').classList.remove('dropdownmenuheader__hidden')
            document.querySelector('.dropdownmenuheader').classList.remove('dropdownmenuheader__hidden')
            ...
            document.getElementById('openbutton').classList.remove('dropdownmenuheader__hidden')
            document.getElementById('closebutton').classList.add('dropdownmenuheader__hidden')
            document.querySelector('.dropdownmenuheader').classList.add('dropdownmenuheader__hidden')
            if(window.innerWidth <=450){
            ...
            <React.Fragment>
                <header className="container_header">
                    <div className="contentheader container_header__contentheader">
                        ...
                        <p className="mobilecontent_cost">3429 руб.</p>
                        <div className="mobilearrowdown">
                            <img width="12" src={Dawn} alt=""/>
                        </div>
                         {/* Mobile containers */}

                        <div className="container_header__content__cart_navbar">
                            <div className="cartcontainer container_header__content__cart_navbar__cartcontainer">
                                <img width="23" src={Cart} alt=""/>
                                <div className="cartcontainer_cartlength">
                                 {this.props.cartlength}
                                </div>
                            </div>
                            <div className="navigationburger container_header__content__cart_navbar__navigationburger" onClick={()=>{this.burgetbutton()}}>
                                <img id="openbutton"   width="25" src={Burgermenu} alt=""/>
                                <img id="closebutton" className="dropdownmenuheader__hidden" width="18" src={Close} alt=""/>
                            </div>
                        </div>
                    </div>
                    <div  className="dropdownmenuheader dropdownmenuheader__hidden">
                        <nav className="dropdownmenuheader__navigation">
                            <ul>
                                <li>
                                   <Link to=''>
                                   Обучающее видео
...
const mapStateToProps = ({cartlength})=>{
    return {cartlength}
}
const mapDispatchToProps ={

}
export default Hoc()(connect(mapStateToProps,mapDispatchToProps)(Header));